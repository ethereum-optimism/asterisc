...
// PRECOMPILECALLRESERVEDGAS is a free data retrieval call binding the contract method 0xb5e7154c.
//
// Solidity: function PRECOMPILE_CALL_RESERVED_GAS() view returns(uint256)
func (_PreimageOracle *PreimageOracleCaller) PRECOMPILECALLRESERVEDGAS(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _PreimageOracle.contract.Call(opts, &out, "PRECOMPILE_CALL_RESERVED_GAS")
...
//
// Solidity: function PRECOMPILE_CALL_RESERVED_GAS() view returns(uint256)
func (_PreimageOracle *PreimageOracleSession) PRECOMPILECALLRESERVEDGAS() (*big.Int, error) {
	return _PreimageOracle.Contract.PRECOMPILECALLRESERVEDGAS(&_PreimageOracle.CallOpts)
}

// PRECOMPILECALLRESERVEDGAS is a free data retrieval call binding the contract method 0xb5e7154c.
//
// Solidity: function PRECOMPILE_CALL_RESERVED_GAS() view returns(uint256)
func (_PreimageOracle *PreimageOracleCallerSession) PRECOMPILECALLRESERVEDGAS() (*big.Int, error) {
	return _PreimageOracle.Contract.PRECOMPILECALLRESERVEDGAS(&_PreimageOracle.CallOpts)
}
...
// LoadPrecompilePreimagePart is a paid mutator transaction binding the contract method 0xea713950.
//
// Solidity: function loadPrecompilePreimagePart(uint256 _partOffset, address _precompile, uint64 _requiredGas, bytes _input) returns()
func (_PreimageOracle *PreimageOracleTransactor) LoadPrecompilePreimagePart(opts *bind.TransactOpts, _partOffset *big.Int, _precompile common.Address, _requiredGas uint64, _input []byte) (*types.Transaction, error) {
	return _PreimageOracle.contract.Transact(opts, "loadPrecompilePreimagePart", _partOffset, _precompile, _requiredGas, _input)
}

// LoadPrecompilePreimagePart is a paid mutator transaction binding the contract method 0xea713950.
//
// Solidity: function loadPrecompilePreimagePart(uint256 _partOffset, address _precompile, uint64 _requiredGas, bytes _input) returns()
func (_PreimageOracle *PreimageOracleSession) LoadPrecompilePreimagePart(_partOffset *big.Int, _precompile common.Address, _requiredGas uint64, _input []byte) (*types.Transaction, error) {
	return _PreimageOracle.Contract.LoadPrecompilePreimagePart(&_PreimageOracle.TransactOpts, _partOffset, _precompile, _requiredGas, _input)
}

// LoadPrecompilePreimagePart is a paid mutator transaction binding the contract method 0xea713950.
//
// Solidity: function loadPrecompilePreimagePart(uint256 _partOffset, address _precompile, uint64 _requiredGas, bytes _input) returns()
func (_PreimageOracle *PreimageOracleTransactorSession) LoadPrecompilePreimagePart(_partOffset *big.Int, _precompile common.Address, _requiredGas uint64, _input []byte) (*types.Transaction, error) {
	return _PreimageOracle.Contract.LoadPrecompilePreimagePart(&_PreimageOracle.TransactOpts, _partOffset, _precompile, _requiredGas, _input)
}
